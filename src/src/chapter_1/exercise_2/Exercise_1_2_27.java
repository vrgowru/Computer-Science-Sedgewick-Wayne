 ...
 *
 * @param - param real number u and v
 *
 * @implSpec - “Gaussian random numbers. Write a program RandomGaussian
 ...
 *
 * @return - r a random number drawn using Gaussian Distribution
 *
 ************************************************************************************/
public class Exercise_1_2_27 {
    public static void main(String[] args) {
        ...
        double r = (Math.sin(2 * Math.PI * v)) * (Math.pow((-2 * Math.log(u)), (float) 1 / 2));
